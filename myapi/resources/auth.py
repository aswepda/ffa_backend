...
class SpotifyAuth(Resource):
    def post(self):
        json = request.get_json()
        authObject = SpotifyOAuth(client_id='d5550bed36f64690a6d2ae32d26023bd', client_secret='7bb9fade755943888c8e27522498b2ed', redirect_uri='https://ffagent.eu.org/#/', open_browser=False, cache_handler=CacheVoid())
