...
def spotify_auth(f):
    ...
    def spotifyAuthFunction(*args, **kwargs):
        if request.headers.get('Authorization') is not None:
            ...
            authObj = SpotifyOAuth(client_id='d5550bed36f64690a6d2ae32d26023bd', client_secret='7bb9fade755943888c8e27522498b2ed', redirect_uri='http://localhost:8080/#/', open_browser=False, cache_handler=CacheVoid())
